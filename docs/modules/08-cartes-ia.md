---
title: "6.4 Créer des cartes & supports de jeu avec l'IA"
description: "Méthodologie complète du syllabus : génération d'images, avatars cohérents, règles et supports de jeu avec ChatGPT, Gemini, Canva, Leonardo et Recraft."
---
...
```mermaid
flowchart LR
    A["1. Explorer (Recraft)<br/>Générer des concepts vectoriels"] --> B["2. Sélectionner & Varier<br/>Ajuster style, couleurs, symboles"]
    B --> C["3. Finaliser (Canva)<br/>Typographie, formats cartes & boîte"]
```
