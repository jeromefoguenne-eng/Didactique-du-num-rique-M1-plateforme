...
description: "Analyse réflexive de profils concrets d'élèves confrontés aux technologies : caractériser la compétence numérique selon le cadre DigComp 2.2."
---

# Atelier 1 : Diagnostic de compétences numériques

<Badge type="info" text="Exercice 1 (10 points)" /> <Badge type="tip" text="Document Officiel" />

Analyse réflexive de profils concrets d'élèves confrontés aux technologies : caractériser la compétence numérique selon le cadre DigComp 2.2.
...
<div class="callout-exercise">
  ...
  <p>
    ...
    <a 
      href="/documents/Exercice-01.docx" 
      download 
      class="btn-primary"
    ...
    <a 
      href="https://docs.google.com/document/d/1b1QhnOoDNyCSdAIEAZx_xq96hQxZsUJH/export?format=pdf" 
      download 
      class="btn-primary"
    ...
    <a 
      href="https://docs.google.com/document/d/1b1QhnOoDNyCSdAIEAZx_xq96hQxZsUJH/copy" 
      target="_blank" 
    ...
    <a 
      href="https://docs.google.com/document/d/1b1QhnOoDNyCSdAIEAZx_xq96hQxZsUJH/preview" 
      target="_blank" 
      rel="noopener noreferrer"
...
<div class="callout-vigilance">
  ...
  <p style="margin-bottom: 0; font-size: 0.88rem;">
    Le fichier sera automatiquement libellé selon la nomenclature officielle (<code>NOM_Prenom_exercice-01_...</code>) et transmis à votre enseignant. Cet exercice est valorisé à hauteur de <strong>10 points</strong> dans votre évaluation continue.
  </p>
</div>
