---
title: "Atelier 3 : Concevoir un guide numérique collaboratif"
description: "Ingénierie didactique d'un livret d'accueil et d'hygiène numérique pour des élèves du tronc commun."
---

# Atelier 3 : Concevoir un guide numérique collaboratif

<Badge type="info" text="Exercice 3 (10 points)" /> <Badge type="tip" text="Document Officiel" />

Ingénierie didactique d'un livret d'accueil et d'hygiène numérique pour des élèves du tronc commun.
...
<div class="callout-exercise">
  ...
  <p>
    ...
    <a 
      href="/documents/Exercice-03.docx" 
      download 
      class="btn-primary"
    ...
    <a 
      href="https://docs.google.com/document/d/12XENuZM1WVyeCnRfu62Oh1_tG8Gkc1Z1/export?format=pdf" 
      download 
      class="btn-primary"
    ...
    <a 
      href="https://docs.google.com/document/d/12XENuZM1WVyeCnRfu62Oh1_tG8Gkc1Z1/copy" 
      target="_blank" 
...
<div class="callout-vigilance">
  ...
  <p style="margin-bottom: 0; font-size: 0.88rem;">
    Le fichier sera automatiquement libellé selon la nomenclature officielle (<code>NOM_Prenom_exercice-03_...</code>) et transmis à votre enseignant. Cet exercice est valorisé à hauteur de <strong>10 points</strong> dans votre évaluation continue.
  </p>
</div>

<ClientOnly>
  <ExerciseBox exerciseId="exercice-03" exerciseTitle="Atelier 3 : Concevoir un guide numérique collaboratif" />
</ClientOnly>
